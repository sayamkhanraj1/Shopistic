         ...
         return (
                  <div className="container my-5">
                           ...
                           <div className="col-md-4 blog-img ">
                                    <div className="blog-img"><img src="https://i.ibb.co/1bDvpmP/blog-1.jpg" alt="blog-img" /></div>
                           ...
                           <div className="col-md-4">
                                    <div className="blog-img"><img src="https://i.ibb.co/hH60sLY/blog-2.jpg" alt="blog-img" /></div>
                                    <div className="text-center blog-content">
                                             <h3>A guide to latest trends</h3>
                                             <span className="text-muted">By Admin</span>
                                    </div>
